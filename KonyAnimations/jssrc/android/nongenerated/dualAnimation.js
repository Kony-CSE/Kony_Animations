function moveDownAnimation() {
    frmDualAnimation.image21237364084434531.animate(getMDAnimationObject(), animMDConfig(), {
        animationStart: startMDCallBack,
        animationEnd: endMDCallBack
    });
}
...
function moveDownAnimation2() {
    frmDualAnimation.image21237125756434844.animate(getMDAnimationObject2(), animMDConfig2(), {
        animationStart: startMDCallBack2,
        animationEnd: endMDCallBack2
    });
}
