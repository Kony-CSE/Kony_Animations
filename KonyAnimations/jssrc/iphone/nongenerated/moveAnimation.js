function moveLeftAnimation() {
    frmMoveAnimation.image2568962376478.animate(getMLAnimationObject(), animMLConfig(), {
        animationStart: startMLCallBack,
        animationEnd: endMLCallBack
    });
}
...
function moveBottomAnimation() {
    frmMoveAnimation.image2568962376478.animate(getMBAnimationObject(), animMBConfig(), {
        animationStart: startMBCallBack,
        animationEnd: endMBCallBack
    });
}
...
function moveRightAnimation() {
    frmMoveAnimation.image2568962376478.animate(getMRAnimationObject(), animMRConfig(), {
        animationStart: startMRCallBack,
        animationEnd: endMRCallBack
    });
}
...
function moveTopAnimation() {
    frmMoveAnimation.image2568962376478.animate(getMTAnimationObject(), animMTConfig(), {
        animationStart: startMTCallBack,
        animationEnd: endMTCallBack
    });
}
